  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        {/* Content Container */}
        <div className="relative z-20 w-full h-full flex flex-col md:flex-row justify-between items-start pt-20 md:pt-32 px-6 md:px-16 pb-12 gap-5 md:gap-0">
          {/* Left Side: THE THEME Only */}
          <div>
            <h2
              className="text-white text-4xl md:text-8xl font-black tracking-tighter uppercase mb-2"
          ...
          <div className="w-full md:w-[45%] ml-auto pr-0 md:pr-[5%] flex flex-col gap-3 md:gap-6 text-left items-start">

            {/* Moved Title Block */}
            <div>
              <h1
                className="text-4xl md:text-6xl font-bold uppercase tracking-widest mb-2"
                style={{
            ...
            <div className="flex flex-col gap-4 md:gap-8 w-full">
              {paragraphs.map((paragraph, index) => (
                ...
                >
                  <p
                    className="text-[#E0E0E0] text-base md:text-xl leading-[1.6] md:leading-[1.7] font-light"
