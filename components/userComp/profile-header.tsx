      ...
      >
        ...
        <div className="relative p-8">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tight mb-2 font-orbitron">{userData.fullName}</h2>
              <p className="text-[#33ABB9] text-sm mb-1">{userData.email}</p>
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="relative flex items-center gap-2 px-4 py-2 text-[#33ABB9] hover:bg-[#33ABB9]/10 transition-all text-sm uppercase tracking-widest font-semibold border border-gray-700/30 bg-black/20"
              >
                {/* Corner Accents */}
              ...
              <div className="space-y-3 max-w-2xl">
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 py-2 bg-linear-to-r from-[#33ABB9] to-[#184344] text-white font-bold uppercase tracking-[0.15em] hover:shadow-[0_0_20px_rgba(51,171,185,0.4)] text-sm flex items-center justify-center gap-2"
                  >
