...
const WorkshopBackground = () => {
  ...
  useEffect(() => {
    ...
    // Colors
    const nodeColor = "#8B5CF6"; // Cyan
    const lineColor = "139, 92, 246"; // RGB for Cyan
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 w-full h-full z-0 bg-[#0f0e13] overflow-hidden"
    >
      {/* Base Gradient Layer */}
